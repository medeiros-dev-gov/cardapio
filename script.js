...
// funcao paara adicionar no carrinho
function addToCar(name, price) {
    const existingItem = cart.find(item => item.name === name)

    // se o item ja existir, aumenta apenas aquantidade + 1
    if (existingItem) {
